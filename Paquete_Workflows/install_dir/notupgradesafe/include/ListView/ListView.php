    ...
    while(list($aVal, $aItem) = each($data))
    {
        ...
        foreach($thepanel->get_list_fields() as $field_name=>$list_field)
        {
            ...
            if($usage != 'query_only')
            {
				...
				$list_field['DetailView'] = $aItem->ACLAccess('DetailView',$aclaccess_is_owner,$aclaccess_in_group);
				$list_field['ListView'] = $aItem->ACLAccess('ListView',$aclaccess_is_owner,$aclaccess_in_group);
				$list_field['EditView'] = $aItem->ACLAccess('EditView',$aclaccess_is_owner,$aclaccess_in_group);
				$list_field['Delete'] = $aItem->ACLAccess('Delete',$aclaccess_is_owner,$aclaccess_in_group);
				/**
